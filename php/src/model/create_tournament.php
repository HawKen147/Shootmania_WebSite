...
<div id="page">
    <div class="main identification">
        ...
        <div class="identification-form sblock">
            ...
            <div class="form-group">You can use an image with the link (you can use dropbox or google drive or others) </div>                    <div class="form-group">You can also give the link of the shootmania server where the tournament will take place. </div>
