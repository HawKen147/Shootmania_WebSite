            ...
            <div class="main identification">
                ...
                <div class="identification-form sblock">
                    <form action="controleur/connect.php" method="post">
                        ...
                        <a class="forgot-password" href="view/password_recover.php" id="partialLostPasswordLink">You lost your password ?</a>
                    ...
                    <div class="new-costumer">
                        ...
                        <a class="button" href="view/register.php">Register here</a>
                    </div>
                </div>
            </div>
        </div>
